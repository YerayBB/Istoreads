...
namespace Istoreads
{
    public class Polygon : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            if (_init)
            {
                _transform.position += (Vector3)_speed;
            }
        }

        public void Initialize(int vertexAmount, Vector3 position, Vector2 speed, float radius)
        {
        ...
        private void CheckIntegrity()
        {
            ...
            else if(_vertexAmount > 5)
            {
                ...
                if(numberFragments > 1)
                {
                    ...
                    PoolSystem.Instance.GetPolygon().Split(amount, vertexs, _transform.position, -_transform.position, _radius);

                }
            }
        }

        public void Split(int amount, Transform[] vertexs, Vector3 position, Vector2 speed, float radius)
        {
