...
namespace Istoreads
{
    public class Polygon : MonoBehaviour
    {
        ...
        public void Initialize(int vertexAmount, Vector3 position, Vector2 direction, float speed, float radius)
        {
        ...
        private void CheckIntegrity()
        {
            ...
            else if(_vertexAmount > 5)
            {
                ...
                if(numberFragments > 1)
                {
                    ...
                    PoolSystem.Instance.GetPolygon().Split(amount, vertexs, _transform.position, -_transform.position, _speed, _radius);

                }
            }
        }

        public void Split(int amount, Transform[] vertexs, Vector3 position, Vector2 direction, float speed, float radius)
        {
